    ...
    $.validation = {
        ...
        bindReset: function () {
            if (!$.validation.resetCalled) {
                ...
                $('.validate').on('focus', function () {
                    $(this).removeClass('correct-alert');
        ...
        processElement: function (el, flagIfCorrect) {
            ...
            if ($.validation.passed) {
                ...
                if (!pass) {
                    $.validation.showError(el);
                }
                else if (flagIfCorrect) {
                    $.validation.showCorrect(el);
                }
        ...
        checkLength: function (value, min, max) {
            ...
            var result = true;
            if (min) {
                result = (vlen >= new Number(min));
            }
            if (result && max) {
                result = (vlen <= new Number(max));
            }
            return result;
        },
        ...
        showCorrect: function (el) {
            $(el).addClass('correct-alert');
        }
    };
}(jQuery));